    ...
    if (!invoice) {
        return (
            <BrandedDashboardShell>
                ...
                <Link href="/invoices" className="mt-4 inline-block workspace-accent-text">
                    Back to invoices
                </Link>
            </BrandedDashboardShell>
        );
    ...
    return (
        <BrandedDashboardShell>
            <div className="max-w-4xl">
                <Link href="/invoices" className="workspace-accent-text text-sm">
                    ← Back to invoices
                </Link>

                <h1 className="mt-4 text-3xl font-light">AI Invoice Reminder</h1>
